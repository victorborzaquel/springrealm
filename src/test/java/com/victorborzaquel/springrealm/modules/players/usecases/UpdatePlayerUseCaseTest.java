...
class UpdatePlayerUseCaseTest {
  ...
  void testUpdatePlayer() {
    ...
    ResponsePlayerDto response = updatePlayerUseCase.execute(id, dto);
  ...
  void testPlayerNotFound() {
    ...
    assertThrows(PlayerNotFoundException.class, () -> updatePlayerUseCase.execute(id, dto), "Player not found");
  ...
  void testExistsPlayerUsername() {
    ...
    assertThrows(PlayerAlreadyExistsException.class, () -> updatePlayerUseCase.execute(id, dto));
