...
class UpdateCharacterUseCaseTest {
  ...
  void testUpdateCharacter() {
    when(characterRepository.findById(id)).thenReturn(Optional.of(entity));

    ResponseCharacterDto response = updateCharacterUseCase.execute(id, dto);
  ...
  void testCharacterNotFound() {
    ...
    assertThrows(CharacterNotFoundException.class, () -> updateCharacterUseCase.execute(id, dto), "Character not found");
  ...
  void testExistsNameCharacter() {
    ...
    assertThrows(CharacterAlreadyExistsException.class, () -> updateCharacterUseCase.execute(id, dto));
